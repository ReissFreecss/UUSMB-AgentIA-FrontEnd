  ...
  return (
    ...
    >
      <div className="relative flex-1">
        ...
        <button
          type="button"
          className="absolute left-4 bottom-5 text-gray-400 hover:text-blue-500 transition-colors duration-20 x-0"
          onClick={() => alert("Función de adjuntar aún no implementada")}
