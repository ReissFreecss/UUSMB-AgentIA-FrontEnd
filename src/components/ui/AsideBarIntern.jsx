      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center space-y-2 w-full pb-3  pt-3">
            ...
            >
              <House color="#CB842E" />
              <span className={`${textClasses} text-primary`}>Inicio</span>
            </div>
            <div
              className={`flex items-center ${
                isExpanded
              ...
              onClick={() => handleNavigation("/cotizacionIntern")}
            >
              <CircleDollarSign color="#CB842E" />
              <span className={`${textClasses} text-primary`}>Cotizar</span>
            </div>
            <div
              className={`flex items-center ${
                isExpanded
            ...
            <div
              ...
              onClick={() => handleNavigation("/profileIntern")}
            >
